...
if(!isset($stuff['category'])){
	...
	elseif(in_array($main,array(
		...
		'592899034667286588'.'/U5uDv7elNLdbuJ6DoPR7Scnm6WtdRtZ5Vu4JQzvU2U66P6k29idvj3BFMtXelwC_2pjQ',
	...
	elseif(in_array($main,array(
		...
		'592033184410238998'.'/JG4ynJOTBurDQj3S3G4c-G6-6e-uFCuKkctDUPNaYyBfB_W8trQjWqGUj5wZuBtsTcu4',
	...
	elseif(in_array($main,array(
		...
		'595380220530393141'.'/l5wgmyRkmAEd_TbSi9AjweHK0LnuXEI4JsGY4574rRGj0IJ1_57Jy-Db5KoXTbgKezBF',
	...
	elseif($main=='567446251218403348'.'/CUpmaityotHk3g4ho-GO83PE2XxJ8xSjq0fbijJ2n901LeFMmitrf1W8sqlaPE_n4_Kc')
		$cat=36;
	elseif(in_array($main,array(
		'577207544603344897'.'/P7Bqf36-jL-3ltRkQZSIDPx6gST-nkv7Gaxs4nOcU_A28AIvUAb42de_fhqZ-ZgB35gs',
		'601833010756583434'.'/Rif9VUoxYJ__dUu0hN4-bqU15pqnnGzEuSZbJhPbaFVoyv2jMyVFgOX6YfjjdwYBv0Cg')))
		$cat=37;
	...
	elseif($id==2892276086)
		$cat=44;
	elseif($main=='595722803119128596'.'/ZYAGik8ULnbOpyQjAjvwcaqq4VCIMrLnp1TBgHpxSEdKGqf3dloXFX81_CS8FxJwoKCP')
		$cat=45;
	elseif($main=='595909226526932997'.'/TxSLHAUjckluEu-5HmxIauMqFlYURF23yGFJN7UQtqG-R7maRGQdvlie2NZX-_j54A_6')
		$cat=46;
	elseif(in_array($main,array(
		'611987425660764179'.'/wu0RHbHVaYmcGtNFrsoMyFA2-j-MFgFhkHkuhrEw7KGxXo-B_swokFbMsk5IuLJF0Vdv',
		'611918549182840832'.'/28y5BXmjwYpdUNnDU8tAyNO2onsbC0fRs0pTUvu5xgkhev1FpiTiiQBKhsh8CCSmFt76')))
		$cat=47;
...
switch($cat){
	...
	case 44:
		...
		break;
	case 45:
		$extra='597330664802746370/vyUJqArrMaBymXr1MSAo79VuFLCglPVcaSH2yryaLNMy5_aEw_YCqSLPFbUmBmDarJ4V';
		break;
	case 46:
		$extra='610328302132920320/uMTgW9RWkW7ltqfCFTLB6ZuBSgDMubpTNBIOKxXvwr8D_M2Vxbfqli1JanooJbWaSpLH';
		break;
	case 47:
		$extra='621593422527987712/ikSWRZaTZkZcGvU5cYE3wHwSS57UIkRBReqs2rb2N_5slOKOlqqx8T60lFXMa6NBJsOz';
		break;
	case 4:
		$extra=null;
		break;
